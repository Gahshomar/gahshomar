...
class GahShomarIndicator:
    def __init__(self, parent, date=None):
        ...
        self.icon_name = 'persian-calendar-{day}'
        self.icon_folder = 'data/icons/ubuntu-mono-dark'
...
# 'INDICATOR_CATEGORY' : 'SYSTEM_SERVICES',
# # SYSTEM_SERVICES
# # APPLICATION_STATUS
# # COMMUNICATIONS
# # HARDWARE
